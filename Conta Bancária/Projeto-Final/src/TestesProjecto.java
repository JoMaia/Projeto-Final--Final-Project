...
import transacoes.CapitalizacaoJuros;
...
public class TestesProjecto {
	...
	public static void testarTransaccoesComContas(){
		...
		System.out.println("A conta tem " + transaccoes.size() + " transacï¿½ï¿½es");
		deb.mostrarExtracto();
	}
	...
	public static void testarBancoClientes(){
		...
		System.out.println("Listar clientes apï¿½s desactivaï¿½ï¿½o");
		Banco.listarClientes("");		
	}
	...
	public static void main(String[] args) {
		...
		testarInteraccaoBanco();
	      ...
	      //InteraccaoBanco.processaMenuContas(new ArrayList<>(List.of(new Debito(), new Prazo())));
